...
DESCRIPTION
    ...
    -d DIRECTORY
        Specify alternate write destination.  Default behavior is to write the
        lowercased .cac file to the source file directory
...
do
    ...
    then
        ...
        then
            echo "Lowercase $cac already exists.  Deleting $cac";
            rm $f
            continue;
        fi
    fi

    echo "Writing lowercase $destFile";
